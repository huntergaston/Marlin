...
#define STRING_CONFIG_H_AUTHOR "(Hunter)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Hunter X1"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "beedc4a3-8ac5-4cd0-9a48-74f9147cd4dd"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Sidewinder X1 @ 200 deg
  #define DEFAULT_Kp 14.33
  #define DEFAULT_Ki 1.08
  #define DEFAULT_Kd 47.54
